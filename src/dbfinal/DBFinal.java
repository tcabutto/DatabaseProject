...
//                stmt.executeUpdate(
//                        "LOAD DATA LOCAL INFILE 'C:\Users\tcabu\workspace\DatabaseProject\src\dbfinal\movies.dat' INTO TABLE movies;"
//                );
            } catch (SQLException ex) {
        ...
        private void populateDB(String fileName, String table) {
            ...
            String populate = "LOAD DATA LOCAL INFILE 'C:/Users/tcabu/workspace/DatabaseProject/src/dbfinal/" + fileName + "' INTO TABLE " + table + ";";
